...
<form onChange={handleBesked} >
    ...
    <input name="name" type="text" className="form-control col-12 g" placeholder="First name" /></div>
    <div className="col-12 my-1 my-sm-0 col-lg-6">
    <input name="name" type="text" className="form-control col-12 g " placeholder="Last name"  /></div>
    <div className="col-12">
      <input name="email" type="email" className="form-control col-12 g pl-3 "  placeholder="email" /> 
