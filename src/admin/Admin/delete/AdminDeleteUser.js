...
import { hentUduser } from "../../helpers/APIkald/apikald";
...
function AdminDeleteUser() {
  ...
  const handleSletE = (e) => {
    axios
      .delete("http://localhost:5039/user/admin/" + ec, {
      ...
      <div className="card ">
        <div className="card-body">
          <h3 className="card-title">
            Er du sikker på at du vil slette denne User:
          </h3>
